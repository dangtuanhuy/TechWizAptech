...
namespace WorkGenerator.Areas.Admin.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type,Contact,Address")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type,Contact,Address")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
